...
# Copied from https://github.com/CircleCI-Public/example-images/blob/master/golang/Dockerfile
...
RUN sudo apt-get update && sudo apt-get install gcc-multilib && sudo apt-get install gcc-mingw-w64
